...
NumericScalar: TypeAlias = Union[np.int32, np.int64, np.uint64, np.float32, np.float64]
NumericArray: TypeAlias = npt.NDArray[NumericScalar]
DTypeName: TypeAlias = Literal["int32", "int64", "uint64", "float32", "float64"]
...
class CsrMatrix:
    ...
    def checked_add(self, other: CsrMatrix) -> CsrMatrix: ...
    def row_sums(self) -> NumericArray: ...
    def column_sums(self) -> NumericArray: ...
    def row_nnz(self) -> Int64Array: ...
    def column_nnz(self) -> Int64Array: ...
    def select_rows(self, row_indices: Int64Array) -> CsrMatrix: ...
...
def spgemm(
    left: CsrMatrix, right: CsrMatrix, *, max_output_nnz: Optional[int] = None
